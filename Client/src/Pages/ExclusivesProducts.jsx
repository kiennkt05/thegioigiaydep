...
import {
    Box, Heading, SimpleGrid, Divider, Button,
    Text,
    useToast,
    Flex,
    HStack,
...
function ExclusivesProducts() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const api = await fetch(`http://localhost:3000/api/special_products?${query.toString()}`);
            ...
            <Flex minH="100vh">
                ...
                <Box flex="1" p={5} minW="0">
                    ...
                    <Flex justify="space-between" align="center" mb={6}>
                        <Box>
                            <Heading size="lg" color="#003977" mb={1}>Exclusives</Heading>
...
export default ExclusivesProducts;
